...
public:
  ...
  void setPredictedBurstTime(int PredictedBurstTime) { this->PredictedBurstTime = PredictedBurstTime; }
  int getPredictedBurstTime(void) { return PredictedBurstTime; }
  ...
  int getRRTime(void) { return RRTime; }
